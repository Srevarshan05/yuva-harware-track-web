...
export default function PptScreeningSection() {
  return (
    ...
    >
      ...
      <div
        className="relative flex flex-col items-center justify-center px-4 sm:px-6 pt-12 pb-24 w-full bg-transparent"
      >
        {/* Ambient glow */}
        <div
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[95%] tracking-tight text-white"
          >
