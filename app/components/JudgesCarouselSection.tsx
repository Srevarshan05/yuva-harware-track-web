...
export default function JudgesCarouselSection() {
  const testimonials = [
    {
      quote:
  ...
  return (
    <section className="relative z-30 w-full px-4 sm:px-8 lg:px-12 pt-6 pb-20 sm:pt-10 sm:pb-28 max-w-7xl mx-auto flex flex-col items-center">
      ...
      <motion.div
        ...
        className="w-full flex flex-col items-center text-center gap-3 mb-8 sm:mb-12"
      >
        <p className="text-[11px] font-mono uppercase tracking-[0.25em] text-indigo-300">
          Technical Jury · Yuva Megathon
        </p>
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal leading-[92%] tracking-[-0.03em] text-white">
          Meet the Judges
        </h2>
        <p className="text-sm sm:text-base text-white/60 max-w-xl mt-1">
          Explore our distinguished panel of hardware architects, edge AI researchers, and startup founders.
        </p>
      </motion.div>
