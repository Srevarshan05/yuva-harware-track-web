...
void main() {
  ...
  float imageAspect = (imageSize.y > 0.0 && imageSize.x > 0.0) ? (imageSize.x / imageSize.y) : 1.0;
  float planeAspect = (planeSize.y > 0.0 && planeSize.x > 0.0) ? (planeSize.x / planeSize.y) : 1.0;
  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      uniforms: {
        tMap: { value: texture },
        uPosition: { value: 0 },
        uPlaneSize: { value: [this.planeWidth || 500, this.planeHeight || 500] },
        uImageSize: { value: [this.planeWidth || 500, this.planeHeight || 500] },
        uSpeed: { value: 0 },
    ...
    if (typeof window !== 'undefined') {
      ...
      img.onload = () => {
        texture.image = img;
        this.program.uniforms.uImageSize.value = [img.naturalWidth || this.planeWidth, img.naturalHeight || this.planeHeight];
      };
...
class Canvas {
  ...
  createMedias() {
    this.medias = this.items.map((image: any, index: any) => {
      return new Media({
        gl: this.gl,
